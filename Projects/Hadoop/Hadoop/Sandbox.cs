...
//            UriBuilder uriBuilder = new UriBuilder("192.168.10.128");
//            uriBuilder.Port = 8000;//8082;
...
//            //Copy(uriBuilder.Uri, "/demo/recipe/in");
...
//            IHadoop myCluster = Microsoft.Hadoop.MapReduce.Hadoop.Connect(uriBuilder.Uri, userName, null);
//            myCluster.StorageSystem.MakeDirectory("user/username/test"); //This works
